...
public class C06_BinarySearch { public static void main(String[] args) {
    ...
    System.out.println(Arrays.binarySearch(arr,istenenSayi)); // Orn: istenen sayi=10 icin  -9 sonucunu verir
